  ...
  return (
    <section className="blog-comments min-w-0 rounded-[20px] border border-border bg-white p-5 sm:p-6 md:p-8">
      <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center">
        <div className="blog-comments-icon flex h-11 w-11 items-center justify-center rounded-full">
          <MessageSquare className="h-5 w-5" />
        </div>
        <div className="min-w-0">
          <h2 className="blog-comments-title text-2xl text-foreground">Comentários</h2>
