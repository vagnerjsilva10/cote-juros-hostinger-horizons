  ...
  return (
    ...
    >
      <div className="border-b border-border/70 px-5 py-3 sm:px-6">
        <span className="blog-section-kicker inline-flex rounded-full border border-border bg-background px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
          {label}
        </span>
      </div>
