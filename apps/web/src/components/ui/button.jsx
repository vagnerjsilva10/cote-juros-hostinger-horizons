...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[12px] text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 motion-reduce:transform-none",
  {
    variants: {
      variant: {
        default:
          "border border-transparent bg-[linear-gradient(180deg,#6070ff_0%,#5263ff_100%)] px-6 py-3 text-white shadow-[0_14px_30px_rgba(91,108,255,0.20)] hover:-translate-y-[1px] hover:brightness-[1.03] hover:shadow-[0_18px_34px_rgba(91,108,255,0.24)]",
        brand:
        ...
        outline:
          "border border-slate-200 bg-white/94 px-6 py-3 text-foreground shadow-[0_8px_18px_rgba(15,23,42,0.05)] hover:-translate-y-[1px] hover:border-[rgba(91,108,255,0.18)] hover:bg-white hover:text-foreground hover:shadow-[0_12px_24px_rgba(15,23,42,0.05)]",
        secondary:
