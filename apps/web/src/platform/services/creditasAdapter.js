...
export const buildCreditasPayload = ({ lead = {}, quizAnswers = {}, recommendation = {}, extraFields = {} } = {}) => ({
  ...
  income: parseMoney(extraFields.income ?? quizAnswers.monthlyIncome ?? quizAnswers.income ?? quizAnswers.renda ?? lead.monthlyIncome ?? lead.income),
  requestedAmount: parseMoney(extraFields.requestedAmount ?? quizAnswers.amount ?? quizAnswers.valor ?? quizAnswers.requestedAmount ?? lead.requestedAmount ?? lead.amount),
  productType: 'loan',
