        ...
        <section id="home-hero" className="cj-home-hero">
          <div className="cj-home-shell cj-home-hero-grid">
            <motion.div {...reveal} className="cj-home-hero-copy">
              ...
              <h1>
                Encontre op��es de cr�dito para o seu perfil
              </h1>
              <p>
                Responda algumas perguntas r�pidas e veja caminhos poss�veis antes de decidir.
              </p>
              <div className="cj-home-hero-form" aria-label="Comece sua an�lise de cr�dito">
                <label htmlFor="home-hero-amount">De quanto voc� precisa?</label>
                <div className="cj-home-hero-input-row">
                  ...
                  <a href="#smart-quiz" className="cj-home-primary-btn" onClick={handleHeroQuizClick}>
                    Ver op��es para meu perfil
                    <ArrowRight className="h-4 w-4" />
                  </a>
                </div>
                <div className="cj-home-quick-amounts" aria-label="Sugest�es r�pidas de valor">
                ...
                <div className="cj-home-hero-microcopy">
                  <span><ShieldCheck className="h-4 w-4" /> Sem cobran�a antecipada</span>
        ...
        <section id="smart-quiz" className="cj-home-section cj-home-quiz-section">
          <div className="cj-home-shell">
            <SectionHeading
              ...
              text="Responda em poucos passos e veja caminhos de cr�dito organizados com clareza, sem promessa de aprova��o."
            />
