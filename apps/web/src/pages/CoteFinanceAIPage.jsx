...
function CoteFinanceAIPage() {
  ...
  const featureCards = [
    ...
    },
    {
      ...
      description: 'Lançamentos com categorias para identificar para onde o dinheiro está indo.'
    },
    {
      icon: Goal,
    ...
    {
      icon: Wallet,
      title: 'Controle de investimentos e carteira',
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'A plataforma identifica padrões de gasto, recorrências e pontos de atenção.'
    },
    {
      step: '3',
      title: 'Aja com plano claro',
      description: 'Priorize ajustes, acompanhe metas e evolua mês a mês com mais previsibilidade.'
    }
  ];
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mt-16 p-6 rounded-2xl border border-border bg-card">
            <p className="text-muted-foreground text-sm leading-relaxed">
              O Cote Finance AI é uma plataforma de organização e inteligência financeira. Esta página não promete aprovação
              de crédito, previsão de score ou correspondência automática com bancos.
            </p>
          </div>
